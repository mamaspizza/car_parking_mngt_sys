...
public final class NotificationReceiver extends BroadcastReceiver {
	//public static String pisclient = "dslab.carparking.PISClient";
    private static final String LOGTAG = LogUtil
            .makeLogTag(NotificationReceiver.class);

    //    private NotificationService notificationService;
    //private PISClient pisclient;
    public NotificationReceiver() {
    	//pisclient = new PISClient();
    	//IntentFilter filter = new IntentFilter();
    	//filter.addAction(NotificationReceiver.BROADCAST_ACTION);
    	//registerReceiver(pisclient, filter);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Constants.ACTION_SHOW_NOTIFICATION.equals(action)) {
            ...
            //Intent i = new Intent(Constants.ACTION_SHOW_NOTIFICATION);
            //Intent i = new Intent(Constants.ACTION_SHOW_NOTIFICATION);
            //i.putExtra(Constants.NOTIFICATION_MESSAGE, notificationMessage);
            //context.sendBroadcast(i) ;
            
            //Intent i = new Intent(context, PISClient.class);
            //Intent i = new Intent(pisclient);
            //i.putExtra("message", notificationMessage);
            ...
            //PISClient pisinterface = i.getClass() ;
          // Intent intc =pisinterface.getIntent() ;
            //pisinterface.setText(notificationMessage);
        }
