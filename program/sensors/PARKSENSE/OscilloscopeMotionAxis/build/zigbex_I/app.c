...
# 112 "/usr/lib/gcc/avr/4.1.2/../../../../avr/include/string.h" 3
extern void *memcpy(void *arg_0x7f282978, const void *arg_0x7f282b10, size_t arg_0x7f282ca8);



extern void *memset(void *arg_0x7f272c70, int arg_0x7f272dc8, size_t arg_0x7f271010);
...
extern size_t strlen(const char *arg_0x7f251df0) __attribute((__pure__)) ;
...
typedef int (*__compar_fn_t)(const void *arg_0x7f211660, const void *arg_0x7f2117f8);
...
# 51 "/opt/tinyos-2.x/tos/platforms/zigbex_core/ZigbexTimer.h"
...
enum __nesc_unnamed4293 {
  ZIGBEX_PRESCALER_ONE = ATM128_CLK16_DIVIDE_256, 
  ZIGBEX_DIVIDE_ONE_FOR_32KHZ_LOG2 = 0, 
  ZIGBEX_PRESCALER_THREE = ATM128_CLK16_DIVIDE_8, 
  ZIGBEX_DIVIDE_THREE_FOR_MICRO_LOG2 = 0, 
...
# 55 "/opt/tinyos-2.x/tos/platforms/zigbex_core/hardware.h"
...
#line 264
  int size;
  int len;
  int (*put)(char arg_0x7ee50138, struct __file *arg_0x7ee50320);
  int (*get)(struct __file *arg_0x7ee50710);
  void *udata;
};
#line 408
...
# 49 "/opt/tinyos-2.x/tos/platforms/zigbex_core/platform_message.h"
#line 46
...
# 47 "/opt/tinyos-2.x/tos/lib/printf/printf.h"
int printfflush();
...
# 16 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Oscilloscope.h"
...
# 38 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Opt_App.h"
#line 32
...
# 58 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/H_NWK_Routing.h"
#line 46
...
# 39 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Interaction.h"
#line 34
...
enum SerialAMQueueP$__nesc_unnamed4332 {
...
enum HilTimerMilliC$__nesc_unnamed4339 {
...
enum /*CC2420ReceiveC.Spi*/CC2420SpiC$4$__nesc_unnamed4340 {
...
enum /*InteractionC.SensirionSht11C*/SensirionSht11C$0$__nesc_unnamed4341 {
  SensirionSht11C$0$TEMP_KEY = 0U
};
enum /*InteractionC.SensirionSht11C*/SensirionSht11C$0$__nesc_unnamed4342 {
...
enum /*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$__nesc_unnamed4343 {
  AdcReadClientC$0$ID = 0U, AdcReadClientC$0$HAL_ID = 0U
};
enum /*InteractionC.UltraredSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$1$__nesc_unnamed4344 {
  AdcReadClientC$1$ID = 1U, AdcReadClientC$1$HAL_ID = 1U
};
# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static void OscopeMotion3AxisM$Boot$booted(void );
# 92 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static void OscopeMotion3AxisM$RadioCtrl$startDone(error_t error);
#line 117
static void OscopeMotion3AxisM$RadioCtrl$stopDone(error_t error);
# 23 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Interaction.nc"
static void OscopeMotion3AxisM$Interaction$StartDoneConfiguration(uint8_t appType, uint8_t optType);



static void OscopeMotion3AxisM$Interaction$getSensorDataDone(App_struct_t *App_Payload, uint8_t app_size);


static void OscopeMotion3AxisM$Interaction$Urgency_Data(uint8_t *Urgency_Payload, uint8_t len);
...
OscopeMotion3AxisM$RadioRecv$receive(
#line 60
message_t * msg, 
void * payload, 
...
static void OscopeMotion3AxisM$RadioSend$sendDone(
#line 85
message_t * msg, 
...
uint8_t len);
# 62 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
am_id_t arg_0x7e557ce8, 
# 85 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
message_t * msg, 
...
# 62 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t addr, 
#line 57
message_t * msg, 
...
/*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$getPayload(
#line 114
message_t * msg, 
...
uint8_t len);
#line 105
static uint8_t /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$maxPayloadLength(void );
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static void /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(
#line 85
message_t * msg, 
...
# 39 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
am_id_t arg_0x7e480818, 
# 114 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
message_t * msg, 
...
#line 59
static void /*HplAtm128InterruptC.IntPin1*/HplAtm128InterruptPinP$1$Irq$edge(bool low_to_high);
#line 35
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static void InteractionM$Read_Humi$readDone(error_t result, InteractionM$Read_Humi$val_t val);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void InteractionM$ProcessCMD$runTask(void );
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static void InteractionM$Read_Ultrared$readDone(error_t result, InteractionM$Read_Ultrared$val_t val);
# 25 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Interaction.nc"
static void InteractionM$Interaction$SetSamplingTime(uint16_t SamplingInfo);
#line 22
static void InteractionM$Interaction$StartConfiguration(App_struct_t *App_Payload);
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static void InteractionM$Read_Photo$readDone(error_t result, InteractionM$Read_Photo$val_t val);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void InteractionM$Set_C328_Restart_Timer_START$runTask(void );
# 29 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
static void InteractionM$CommunicationWithOPT$parsing_config(uint8_t *RecvMsg);

static void InteractionM$CommunicationWithOPT$parsing_control(uint8_t *RecvMsg);
static void InteractionM$CommunicationWithOPT$parsing_longDT(uint8_t *RecvMsg);
#line 30
static void InteractionM$CommunicationWithOPT$parsing_sensor(uint8_t *RecvMsg);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static void InteractionM$Read_Temp$readDone(error_t result, InteractionM$Read_Temp$val_t val);
...
#line 116
static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$writeStatusRegDone(error_t result);
#line 100
static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$readStatusRegDone(error_t result, uint8_t val);
#line 54
static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$resetDone(error_t result);
#line 69
static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureTemperatureDone(error_t result, uint16_t val);
...
# 84 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11.nc"
static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureHumidityDone(error_t result, uint16_t val);
#line 116
static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$writeStatusRegDone(error_t result);
#line 100
static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$readStatusRegDone(error_t result, uint8_t val);
#line 54
static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$resetDone(error_t result);
#line 69
...
# 64 "/opt/tinyos-2.x/tos/chips/atm128/pins/HplAtm128Interrupt.nc"
static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$fired(void );
# 50 "/opt/tinyos-2.x/tos/interfaces/GpioInterrupt.nc"
static error_t /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Interrupt$disable(void );
#line 43
static error_t /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Interrupt$enableFallingEdge(void );
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
static error_t /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$Init$init(void );
# 69 "/opt/tinyos-2.x/tos/interfaces/ResourceQueue.nc"
static error_t /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$enqueue(resource_client_id_t id);
#line 43
static bool /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$isEmpty(void );
...
static bool /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$isEnqueued(resource_client_id_t id);
...
static resource_client_id_t /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$dequeue(void );
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
...
# 92 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static void /*HplSensirionSht11C.SplitControlPowerManagerC.PowerManager*/PowerManagerP$0$SplitControl$startDone(error_t error);
#line 117
static void /*HplSensirionSht11C.SplitControlPowerManagerC.PowerManager*/PowerManagerP$0$SplitControl$stopDone(error_t error);
...
uint8_t arg_0x7d9faa58);
# 56 "/opt/tinyos-2.x/tos/interfaces/ResourceDefaultOwner.nc"
static error_t /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceDefaultOwner$release(void );
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 31 "/opt/tinyos-2.x/tos/platforms/zigbex_core/ZigbexBusAdc.nc"
static uint8_t ZigbexBusP$Adc1$getChannel(void );
# 49 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128Uart.nc"
static void CommunicationWithOPTM$HPLUART$rxDone(uint8_t data);
#line 47
static void CommunicationWithOPTM$HPLUART$txDone(void );
# 26 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
static void CommunicationWithOPTM$CommunicationWithOPT$RequestLongMSG(uint8_t OptType, uint8_t Seq);
static void CommunicationWithOPTM$CommunicationWithOPT$SpecialControlMSG(uint8_t TXpacketType, uint8_t OptType, uint8_t Cmd1, uint8_t Cmd2, uint8_t *SetDataBuff, uint8_t RXpacketType);
#line 25
...
# 30 "/opt/tinyos-2.x/tos/platforms/zigbex_core/SCSuartDBG.nc"
static void NoSCSuartDBGC$SCSuartDBG$UARTSend(uint8_t *data, uint8_t len);
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t OscopeMotion3AxisM$RadioCtrl$start(void );
# 25 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Interaction.nc"
static void OscopeMotion3AxisM$Interaction$SetSamplingTime(uint16_t SamplingInfo);
#line 22
static void OscopeMotion3AxisM$Interaction$StartConfiguration(App_struct_t *App_Payload);
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void OscopeMotion3AxisM$Leds$led0Toggle(void );
#line 72
static void OscopeMotion3AxisM$Leds$led1Toggle(void );
#line 89
static void OscopeMotion3AxisM$Leds$led2Toggle(void );
# 62 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t OscopeMotion3AxisM$RadioSend$send(am_addr_t addr, 
#line 57
message_t * msg, 
...
OscopeMotion3AxisM$RadioSend$getPayload(
#line 114
message_t * msg, 
...
uint8_t len);
#line 105
static uint8_t OscopeMotion3AxisM$RadioSend$maxPayloadLength(void );
# 46 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static inline void OscopeMotion3AxisM$checkReadings(void );
static inline void OscopeMotion3AxisM$calc_EUC(void );

App_struct_t OscopeMotion3AxisM$AP_Frame;
message_t OscopeMotion3AxisM$packet;
uint16_t OscopeMotion3AxisM$currentdata[1 + 3];
uint16_t OscopeMotion3AxisM$prevdata[1 + 3];

oscilloscope_t OscopeMotion3AxisM$local;

uint8_t OscopeMotion3AxisM$reading;

bool OscopeMotion3AxisM$locked;
bool OscopeMotion3AxisM$suppress_count_change;


static inline void OscopeMotion3AxisM$report_problem(void );
static inline void OscopeMotion3AxisM$report_sent(void );
static inline void OscopeMotion3AxisM$report_received(void );

static inline void OscopeMotion3AxisM$Boot$booted(void );
...
static inline void OscopeMotion3AxisM$Interaction$StartDoneConfiguration(uint8_t appType, uint8_t optType);
#line 105
static inline void OscopeMotion3AxisM$RadioCtrl$startDone(error_t error);
#line 120
static inline void OscopeMotion3AxisM$RadioCtrl$stopDone(error_t error);



static inline void OscopeMotion3AxisM$Interaction$Urgency_Data(uint8_t *Urgency_Payload, uint8_t len);





static inline void OscopeMotion3AxisM$Interaction$getSensorDataDone(App_struct_t *App_Payload, uint8_t App_size);
#line 153
static inline void OscopeMotion3AxisM$checkReadings(void );
#line 175
static void OscopeMotion3AxisM$RadioSend$sendDone(message_t *msg, error_t error);
...
static inline message_t *OscopeMotion3AxisM$RadioRecv$receive(message_t *msg, void *payload, uint8_t len);
#line 208
static inline void OscopeMotion3AxisM$calc_EUC(void );
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
# 42 "/opt/tinyos-2.x/tos/platforms/zigbex_core/PlatformP.nc"
...
# 26 "/opt/tinyos-2.x/tos/platforms/zigbex_core/MotePlatformP.nc"
...
# 33 "/opt/tinyos-2.x/tos/platforms/zigbex_core/MeasureClockC.nc"
...
#line 79
enum SerialP$__nesc_unnamed4351 {
...
#line 109
typedef enum SerialP$__nesc_unnamed4354 {
...
#line 122
typedef struct SerialP$__nesc_unnamed4356 {
  uint8_t writePtr;
  uint8_t readPtr;
...
#line 128
typedef struct SerialP$__nesc_unnamed4357 {
  uint8_t state;
  uint8_t buf;
} SerialP$tx_buf_t;
...
#line 133
typedef struct SerialP$__nesc_unnamed4358 {
  uint8_t writePtr;
  uint8_t readPtr;
...
# 146 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
...
#line 263
enum /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$__nesc_unnamed4360 {
#line 263
...
#line 54
#line 50
typedef enum /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$__nesc_unnamed4361 {
...
enum /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$__nesc_unnamed4362 {
...
#line 62
typedef struct /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$__nesc_unnamed4363 {
  uint8_t which : 1;
...
#line 44
typedef struct HdlcTranslateC$__nesc_unnamed4364 {
...
# 88 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
...
enum /*CounterMicro32C.Transform32*/TransformCounterC$0$__nesc_unnamed4365 {
...
enum /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4366 {
#line 118
...
#line 161
enum /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4367 {
#line 161
...
#line 49
#line 47
typedef struct /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4368 {
  message_t * msg;
...
enum PrintfP$__nesc_unnamed4369 {
#line 127
...
#line 100
enum PrintfP$__nesc_unnamed4370 {
  PrintfP$S_STOPPED, 
  PrintfP$S_STARTED, 
  PrintfP$S_FLUSHING
};
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(
#line 85
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(
#line 56
message_t * msg, 
...
/*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$getPayload(
#line 111
message_t * msg, 
...
uint8_t len);
#line 101
static uint8_t /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$maxPayloadLength(void );
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static void /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static inline error_t /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(message_t *m, error_t err);



static inline uint8_t /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$maxPayloadLength(void );



static inline void */*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$getPayload(message_t *m, uint8_t len);
# 62 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
message_t * amsg);
# 118 "/opt/tinyos-2.x/tos/system/AMQueueImplP.nc"
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$__nesc_unnamed4371 {
#line 118
  AMQueueImplP$1$CancelTask = 9U
};
#line 118
...
#line 161
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$__nesc_unnamed4372 {
#line 161
  AMQueueImplP$1$errorTask = 10U
};
#line 161
...
#line 49
#line 47
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$__nesc_unnamed4373 {
  message_t * msg;
...
#line 58
enum CC2420CsmaP$__nesc_unnamed4377 {
...
#line 85
#line 79
typedef enum CC2420ControlP$__nesc_unnamed4380 {
...
enum /*Counter32khz32C.Transform32*/TransformCounterC$1$__nesc_unnamed4381 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform32*/TransformAlarmC$0$__nesc_unnamed4382 {
...
# 69 "/opt/tinyos-2.x/tos/platforms/zigbex_core/chips/cc2420/HplCC2420InterruptsP.nc"
enum HplCC2420InterruptsP$__nesc_unnamed4383 {
#line 69
...
enum CC2420SpiP$__nesc_unnamed4384 {
#line 88
...
#line 63
enum CC2420SpiP$__nesc_unnamed4385 {
  CC2420SpiP$RESOURCE_COUNT = 5U, 
  CC2420SpiP$NO_HOLDER = 0xFF
};


enum CC2420SpiP$__nesc_unnamed4386 {
  CC2420SpiP$S_IDLE, 
  CC2420SpiP$S_BUSY
};
...
enum StateImplP$__nesc_unnamed4387 {
  StateImplP$S_IDLE = 0
};
...
# 51 "/opt/tinyos-2.x/tos/platforms/zigbex_core/chips/cc2420/HplCC2420SpiP.nc"
...
#line 80
typedef enum CC2420TransmitP$__nesc_unnamed4394 {
...
enum CC2420ReceiveP$__nesc_unnamed4396 {
#line 115
...
#line 76
#line 70
typedef enum CC2420ReceiveP$__nesc_unnamed4397 {
...
enum /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$__nesc_unnamed4399 {
...
enum /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$__nesc_unnamed4400 {
#line 63
  AlarmToTimerC$0$fired = 21U
};
#line 63
...
uint8_t arg_0x7dc65010);
#line 60
enum /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$__nesc_unnamed4401 {
#line 60
  VirtualizeTimerC$0$updateFromTimer = 22U
};
#line 60
typedef int /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$__nesc_sillytask_updateFromTimer[/*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$updateFromTimer];
#line 42
enum /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$__nesc_unnamed4402 {
...
#line 48
typedef struct /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$__nesc_unnamed4403 {
...
enum UniqueSendP$__nesc_unnamed4404 {
  UniqueSendP$S_IDLE, 
...
#line 56
struct UniqueReceiveP$__nesc_unnamed4405 {
  am_addr_t source;
  uint8_t dsn;
...
enum UniqueReceiveP$__nesc_unnamed4406 {
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void InteractionM$SensorCheckTimer$startPeriodic(uint32_t dt);
...
static void InteractionM$SensorCheckTimer$startOneShot(uint32_t dt);
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void InteractionM$C328_Reset_Timer$startPeriodic(uint32_t dt);
#line 67
...
# 23 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Interaction.nc"
static void InteractionM$Interaction$StartDoneConfiguration(uint8_t appType, uint8_t optType);



static void InteractionM$Interaction$getSensorDataDone(App_struct_t *App_Payload, uint8_t app_size);


static void InteractionM$Interaction$Urgency_Data(uint8_t *Urgency_Payload, uint8_t len);
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static error_t InteractionM$Read_Photo$read(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t InteractionM$Set_C328_Restart_Timer_START$postTask(void );
# 26 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
static void InteractionM$CommunicationWithOPT$RequestLongMSG(uint8_t OptType, uint8_t Seq);
static void InteractionM$CommunicationWithOPT$SpecialControlMSG(uint8_t TXpacketType, uint8_t OptType, uint8_t Cmd1, uint8_t Cmd2, uint8_t *SetDataBuff, uint8_t RXpacketType);
#line 25
static void InteractionM$CommunicationWithOPT$RequestSensorMSG(uint8_t OptType);
#line 22
...
static void InteractionM$CommunicationWithOPT$SendControlMSG(uint8_t OptType, uint8_t Cmd1, uint8_t Cmd2, uint8_t *SetDataBuff);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void InteractionM$ConfigTimeout$startOneShot(uint32_t dt);
...
# 30 "/opt/tinyos-2.x/tos/platforms/zigbex_core/SCSuartDBG.nc"
static void InteractionM$SCSuartDBG$UARTSend(uint8_t *data, uint8_t len);
# 62 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
enum InteractionM$__nesc_unnamed4407 {
#line 62
  InteractionM$TaskStartDoneConfiguration = 23U
};
#line 62
typedef int InteractionM$__nesc_sillytask_TaskStartDoneConfiguration[InteractionM$TaskStartDoneConfiguration];
enum InteractionM$__nesc_unnamed4408 {
#line 63
  InteractionM$TaskGetSensorDataDone = 24U
};
#line 63
...
char InteractionM$IC_DBG_buff[32];
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$readDone(error_t result, /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$val_t val);
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$readDone(error_t result, /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$val_t val);
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$Timer$startOneShot(uint32_t dt);




static void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$Timer$stop(void );
# 100 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
enum /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$__nesc_unnamed4414 {
#line 100
  SensirionSht11LogicP$0$readSensor = 30U
};
#line 100
...
enum /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$__nesc_unnamed4415 {
#line 101
  SensirionSht11LogicP$0$signalStatusDone = 31U
};
#line 101
...
#line 70
#line 64
typedef enum /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$__nesc_unnamed4416 {
...
enum /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$__nesc_unnamed4417 {
...
# 92 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static void HplSensirionSht11P$SplitControl$startDone(error_t error);
#line 117
static void HplSensirionSht11P$SplitControl$stopDone(error_t error);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void HplSensirionSht11P$Timer$startOneShot(uint32_t dt);
# 49 "/opt/tinyos-2.x/tos/platforms/zigbex_core/sensor/sht11/HplSensirionSht11P.nc"
enum HplSensirionSht11P$__nesc_unnamed4418 {
#line 49
  HplSensirionSht11P$stopTask = 32U
};
#line 49
...
# 45 "/opt/tinyos-2.x/tos/chips/atm128/pins/HplAtm128Interrupt.nc"
static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$clear(void );
#line 40
static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$disable(void );
#line 59
static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$edge(bool low_to_high);
#line 35
static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$enable(void );
# 57 "/opt/tinyos-2.x/tos/interfaces/GpioInterrupt.nc"
static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Interrupt$fired(void );
# 15 "/opt/tinyos-2.x/tos/chips/atm128/pins/Atm128GpioInterruptC.nc"
static error_t /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$enable(bool rising);
#line 29
static inline error_t /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Interrupt$enableFallingEdge(void );



static inline error_t /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Interrupt$disable(void );




static inline void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$fired(void );
# 39 "/opt/tinyos-2.x/tos/system/FcfsResourceQueueC.nc"
enum /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$__nesc_unnamed4419 {
#line 39
  FcfsResourceQueueC$1$NO_ENTRY = 0xFF
};
uint8_t /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$resQ[2U];
uint8_t /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qHead = /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY;
uint8_t /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qTail = /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY;

static inline error_t /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$Init$init(void );




static inline bool /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$isEmpty(void );



static inline bool /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$isEnqueued(resource_client_id_t id);



static inline resource_client_id_t /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$dequeue(void );
#line 72
static inline error_t /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$enqueue(resource_client_id_t id);
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
...
uint8_t arg_0x7d9faa58);
# 69 "/opt/tinyos-2.x/tos/interfaces/ResourceQueue.nc"
static error_t /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$Queue$enqueue(resource_client_id_t id);
#line 43
...
enum /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$__nesc_unnamed4420 {
#line 75
  ArbiterP$0$grantedTask = 33U
};
#line 75
...
#line 67
enum /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$__nesc_unnamed4421 {
#line 67
  ArbiterP$0$RES_CONTROLLED, ArbiterP$0$RES_GRANTING, ArbiterP$0$RES_IMM_GRANTING, ArbiterP$0$RES_BUSY
};
#line 68
enum /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$__nesc_unnamed4422 {
#line 68
  ArbiterP$0$default_owner_id = 2U
};
#line 69
enum /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$__nesc_unnamed4423 {
#line 69
...
#line 180
static inline uint8_t /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$ResourceDefaultOwner$isOwner(void );
...
static bool /*HplSensirionSht11C.SplitControlPowerManagerC.PowerManager*/PowerManagerP$0$ResourceDefaultOwner$isOwner(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
enum /*HplSensirionSht11C.SplitControlPowerManagerC.PowerManager*/PowerManagerP$0$__nesc_unnamed4424 {
#line 63
  PowerManagerP$0$startTask = 34U
};
#line 63
...
enum /*HplSensirionSht11C.SplitControlPowerManagerC.PowerManager*/PowerManagerP$0$__nesc_unnamed4425 {
#line 68
  PowerManagerP$0$stopTask = 35U
};
#line 68
...
#line 78
struct Atm128AdcP$__nesc_unnamed4426 {
  bool multiple : 1;
  bool precise : 1;
  uint8_t channel : 5;
} Atm128AdcP$f;
...
# 40 "/opt/tinyos-2.x/tos/chips/atm128/adc/HplAtm128AdcP.nc"
...
enum /*Atm128AdcC.AdcArbiter.Queue*/RoundRobinResourceQueueC$0$__nesc_unnamed4427 {
...
uint8_t arg_0x7d9faa58);
# 69 "/opt/tinyos-2.x/tos/interfaces/ResourceQueue.nc"
static error_t /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Queue$enqueue(resource_client_id_t id);
#line 43
...
# 73 "/opt/tinyos-2.x/tos/interfaces/ResourceDefaultOwner.nc"
static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceDefaultOwner$requested(void );
#line 46
static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceDefaultOwner$granted(void );
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 75 "/opt/tinyos-2.x/tos/system/ArbiterP.nc"
enum /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$__nesc_unnamed4428 {
#line 75
  ArbiterP$1$grantedTask = 36U
};
#line 75
...
#line 67
enum /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$__nesc_unnamed4429 {
#line 67
  ArbiterP$1$RES_CONTROLLED, ArbiterP$1$RES_GRANTING, ArbiterP$1$RES_IMM_GRANTING, ArbiterP$1$RES_BUSY
};
#line 68
enum /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$__nesc_unnamed4430 {
#line 68
  ArbiterP$1$default_owner_id = 2U
};
#line 69
enum /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$__nesc_unnamed4431 {
#line 69
...
uint8_t /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$resId = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$default_owner_id;
...
#line 129
static inline error_t /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceDefaultOwner$release(void );
#line 186
...
enum AdcP$__nesc_unnamed4432 {
#line 103
  AdcP$acquiredData = 37U
};
#line 103
typedef int AdcP$__nesc_sillytask_acquiredData[AdcP$acquiredData];
#line 57
enum AdcP$__nesc_unnamed4433 {
  AdcP$IDLE, 
  AdcP$ACQUIRE_DATA, 
...
# 35 "/opt/tinyos-2.x/tos/interfaces/GeneralIO.nc"
static void UltraredP$UltraredPin$makeOutput(void );
#line 29
static void UltraredP$UltraredPin$set(void );
static void UltraredP$UltraredPin$clr(void );
# 40 "/opt/tinyos-2.x/tos/platforms/zigbex_core/sensor/UltraredP.nc"
...
# 42 "/opt/tinyos-2.x/tos/platforms/zigbex_core/ZigbexBusP.nc"
...
static void CommunicationWithOPTM$HPLUART$tx(uint8_t data);
# 74 "/opt/tinyos-2.x/tos/interfaces/StdControl.nc"
static error_t CommunicationWithOPTM$HplUartTxControl$start(void );
# 29 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
static void CommunicationWithOPTM$CommunicationWithOPT$parsing_config(uint8_t *RecvMsg);

static void CommunicationWithOPTM$CommunicationWithOPT$parsing_control(uint8_t *RecvMsg);
static void CommunicationWithOPTM$CommunicationWithOPT$parsing_longDT(uint8_t *RecvMsg);
#line 30
static void CommunicationWithOPTM$CommunicationWithOPT$parsing_sensor(uint8_t *RecvMsg);
# 74 "/opt/tinyos-2.x/tos/interfaces/StdControl.nc"
static error_t CommunicationWithOPTM$HplUartRxControl$start(void );
# 43 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPTM.nc"
...
# 16 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/NoSCSuartDBGC.nc"
...
#line 51
# 41 "/opt/tinyos-2.x/tos/platforms/zigbex_core/MeasureClockC.nc"
static inline error_t MeasureClockC$Init$init(void )
#line 41
{
  /* atomic removed: atomic calls only */
...
#line 51
# 49 "/opt/tinyos-2.x/tos/platforms/zigbex_core/PlatformP.nc"
static inline error_t PlatformP$Init$init(void )
{
  error_t ok;
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Resource$request(uint8_t arg_0x7d8e6590){
#line 78
  unsigned char result;
#line 78

#line 78
  switch (arg_0x7d8e6590) {
#line 78
    case /*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$ID:
#line 78
      result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$request(/*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$HAL_ID);
#line 78
      break;
#line 78
    case /*InteractionC.UltraredSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$1$ID:
#line 78
      result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$request(/*InteractionC.UltraredSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$1$HAL_ID);
#line 78
      break;
#line 78
    default:
#line 78
      result = /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Resource$default$request(arg_0x7d8e6590);
#line 78
      break;
#line 78
    }
...
#line 55
  result = /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Read$read(/*InteractionC.UltraredSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$1$ID);
#line 55
...
#line 55
# 375 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$Read_Photo$readDone(error_t err, uint16_t val)
#line 375
{
  if (err == SUCCESS) {
...
#line 56
# 381 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$Read_Ultrared$readDone(error_t err, uint16_t val)
#line 381
{
  if (err == SUCCESS) {
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static void /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Read$readDone(uint8_t arg_0x7d8e9610, error_t result, /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Read$val_t val){
#line 63
  switch (arg_0x7d8e9610) {
#line 63
    case /*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$ID:
#line 63
      InteractionM$Read_Photo$readDone(result, val);
#line 63
      break;
#line 63
    case /*InteractionC.UltraredSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$1$ID:
#line 63
      InteractionM$Read_Ultrared$readDone(result, val);
#line 63
      break;
#line 63
    default:
#line 63
      /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Read$default$readDone(arg_0x7d8e9610, result, val);
#line 63
      break;
#line 63
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Resource$release(uint8_t arg_0x7d8e6590){
#line 110
  unsigned char result;
#line 110
...
#line 110
    case /*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$ID:
#line 110
      result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$release(/*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$HAL_ID);
#line 110
      break;
#line 110
    case /*InteractionC.UltraredSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$1$ID:
#line 110
      result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$release(/*InteractionC.UltraredSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$1$HAL_ID);
#line 110
      break;
#line 110
    default:
#line 110
      result = /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Resource$default$release(arg_0x7d8e6590);
#line 110
      break;
#line 110
    }
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static void AdcP$Read$readDone(uint8_t arg_0x7d902510, error_t result, AdcP$Read$val_t val){
#line 63
  /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Service$readDone(arg_0x7d902510, result, val);
#line 63
}
#line 63
# 103 "/opt/tinyos-2.x/tos/chips/atm128/adc/AdcP.nc"
...
# 30 "/opt/tinyos-2.x/tos/interfaces/GeneralIO.nc"
inline static void UltraredP$UltraredPin$clr(void ){
#line 30
  /*HplAtm128GeneralIOC.PortC.Bit1*/HplAtm128GeneralIOPinP$17$IO$clr();
#line 30
}
#line 30
# 57 "/opt/tinyos-2.x/tos/platforms/zigbex_core/sensor/UltraredP.nc"
static inline void UltraredP$ResourceConfigure$unconfigure(void )
#line 57
{
  UltraredP$UltraredPin$clr();
}
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceConfigure$unconfigure(uint8_t arg_0x7d9faa58){
#line 55
  switch (arg_0x7d9faa58) {
#line 55
    case /*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$HAL_ID:
#line 55
      UltraredP$ResourceConfigure$unconfigure();
#line 55
      break;
#line 55
    case /*InteractionC.UltraredSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$1$HAL_ID:
#line 55
      UltraredP$ResourceConfigure$unconfigure();
#line 55
      break;
#line 55
    default:
#line 55
      /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceConfigure$default$unconfigure(arg_0x7d9faa58);
#line 55
      break;
#line 55
    }
...
#line 44
# 73 "/opt/tinyos-2.x/tos/chips/atm128/adc/HplAtm128AdcP.nc"
static inline void HplAtm128AdcP$HplAtm128Adc$disableAdc(void )
#line 73
{
...
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceDefaultOwner$granted(void ){
#line 46
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceRequested$requested(uint8_t arg_0x7d9fc690){
#line 43
    /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceRequested$default$requested(arg_0x7d9fc690);
#line 43
}
#line 43
...
# 69 "/opt/tinyos-2.x/tos/interfaces/ResourceQueue.nc"
inline static error_t /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Queue$enqueue(resource_client_id_t id){
#line 69
  unsigned char result;
#line 69
...
#line 130
    {
      if (/*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$resId == /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$default_owner_id) {
...
#line 56
  result = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceDefaultOwner$release();
#line 56
...
#line 56
# 69 "/opt/tinyos-2.x/tos/chips/atm128/adc/HplAtm128AdcP.nc"
static inline void HplAtm128AdcP$HplAtm128Adc$enableAdc(void )
#line 69
{
  * (volatile uint8_t *)(0x06 + 0x20) |= 1 << 7;
...
# 73 "/opt/tinyos-2.x/tos/interfaces/ResourceDefaultOwner.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceDefaultOwner$requested(void ){
#line 73
...
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static error_t /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Service$read(uint8_t arg_0x7d8e86a0){
#line 55
  unsigned char result;
#line 55

#line 55
  result = AdcP$Read$read(arg_0x7d8e86a0);
#line 55
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$granted(uint8_t arg_0x7d9fdbd8){
#line 92
  switch (arg_0x7d9fdbd8) {
#line 92
    case /*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$HAL_ID:
#line 92
      /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Resource$granted(/*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$ID);
#line 92
      break;
#line 92
    case /*InteractionC.UltraredSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$1$HAL_ID:
#line 92
      /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Resource$granted(/*InteractionC.UltraredSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$1$ID);
#line 92
      break;
#line 92
    default:
#line 92
      /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Resource$default$granted(arg_0x7d9fdbd8);
#line 92
      break;
#line 92
    }
...
# 29 "/opt/tinyos-2.x/tos/interfaces/GeneralIO.nc"
inline static void UltraredP$UltraredPin$set(void ){
#line 29
...
# 35 "/opt/tinyos-2.x/tos/interfaces/GeneralIO.nc"
inline static void UltraredP$UltraredPin$makeOutput(void ){
#line 35
  /*HplAtm128GeneralIOC.PortC.Bit1*/HplAtm128GeneralIOPinP$17$IO$makeOutput();
#line 35
}
#line 35
# 52 "/opt/tinyos-2.x/tos/platforms/zigbex_core/sensor/UltraredP.nc"
static inline void UltraredP$ResourceConfigure$configure(void )
#line 52
{
  UltraredP$UltraredPin$makeOutput();
  UltraredP$UltraredPin$set();
}
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceConfigure$configure(uint8_t arg_0x7d9faa58){
#line 49
  switch (arg_0x7d9faa58) {
#line 49
    case /*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$HAL_ID:
...
#line 49
    default:
#line 49
      /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceConfigure$default$configure(arg_0x7d9faa58);
#line 49
      break;
#line 49
    }
...
# 103 "/opt/tinyos-2.x/tos/platforms/zigbex_core/MeasureClockC.nc"
static inline uint8_t MeasureClockC$Atm128Calibrate$adcPrescaler(void )
#line 103
{
...
#line 53
# 50 "/opt/tinyos-2.x/tos/chips/atm128/adc/HplAtm128AdcP.nc"
static inline uint8_t HplAtm128AdcP$Admux2int(Atm128Admux_t x)
#line 50
{
#line 50
...
# 25 "/opt/tinyos-2.x/tos/chips/atm128/adc/Atm128AdcConfig.nc"
inline static uint8_t AdcP$Atm128AdcConfig$getChannel(uint8_t arg_0x7d8ff9c0){
#line 25
  unsigned char result;
#line 25

#line 25
  switch (arg_0x7d8ff9c0) {
#line 25
    case /*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$ID:
#line 25
...
#line 25
    default:
#line 25
      result = AdcP$Atm128AdcConfig$default$getChannel(arg_0x7d8ff9c0);
#line 25
      break;
#line 25
    }
...
# 44 "/opt/tinyos-2.x/tos/platforms/zigbex_core/sensor/UltraredP.nc"
static inline uint8_t UltraredP$Atm128AdcConfig$getRefVoltage(void )
#line 44
{
...
# 32 "/opt/tinyos-2.x/tos/chips/atm128/adc/Atm128AdcConfig.nc"
inline static uint8_t AdcP$Atm128AdcConfig$getRefVoltage(uint8_t arg_0x7d8ff9c0){
#line 32
  unsigned char result;
#line 32
...
#line 32
    default:
#line 32
      result = AdcP$Atm128AdcConfig$default$getRefVoltage(arg_0x7d8ff9c0);
#line 32
      break;
#line 32
    }
...
# 48 "/opt/tinyos-2.x/tos/platforms/zigbex_core/sensor/UltraredP.nc"
static inline uint8_t UltraredP$Atm128AdcConfig$getPrescaler(void )
#line 48
{
...
# 39 "/opt/tinyos-2.x/tos/chips/atm128/adc/Atm128AdcConfig.nc"
inline static uint8_t AdcP$Atm128AdcConfig$getPrescaler(uint8_t arg_0x7d8ff9c0){
#line 39
  unsigned char result;
#line 39
...
#line 39
    default:
#line 39
      result = AdcP$Atm128AdcConfig$default$getPrescaler(arg_0x7d8ff9c0);
#line 39
      break;
#line 39
    }
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void HplSensirionSht11P$Timer$startOneShot(uint32_t dt){
#line 62
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(4U, dt);
#line 62
}
#line 62
# 51 "/opt/tinyos-2.x/tos/platforms/zigbex_core/sensor/sht11/HplSensirionSht11P.nc"
static inline error_t HplSensirionSht11P$SplitControl$start(void )
#line 51
{
...
#line 33
# 60 "/opt/tinyos-2.x/tos/platforms/zigbex_core/sensor/sht11/HplSensirionSht11P.nc"
static inline error_t HplSensirionSht11P$SplitControl$stop(void )
#line 60
{
...
#line 55
# 363 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$Read_Temp$readDone(error_t err, uint16_t val)
#line 363
{
  if (err == SUCCESS) {
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$readDone(error_t result, /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Temperature$val_t val){
#line 63
  InteractionM$Read_Temp$readDone(result, val);
#line 63
}
#line 63
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
#line 110
# 111 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline error_t /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$measureTemperature(uint8_t client)
#line 111
{
...
#line 55
  result = /*WireAdcP.ArbitrateRead*/ArbitratedReadC$0$Read$read(/*InteractionC.PhotoSensorC.DemoChannel.AdcReadClientC*/AdcReadClientC$0$ID);
#line 55
...
#line 55
# 369 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$Read_Humi$readDone(error_t err, uint16_t val)
#line 369
{
  if (err == SUCCESS) {
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static void /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$readDone(error_t result, /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Humidity$val_t val){
#line 63
  InteractionM$Read_Humi$readDone(result, val);
#line 63
}
#line 63
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
#line 110
# 119 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline error_t /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$measureHumidity(uint8_t client)
#line 119
{
  if (!/*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$on) {
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$Resource$granted(uint8_t arg_0x7d9fdbd8){
#line 92
  switch (arg_0x7d9fdbd8) {
#line 92
...
#line 92
    default:
#line 92
      /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$Resource$default$granted(arg_0x7d9fdbd8);
#line 92
      break;
#line 92
    }
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$ResourceConfigure$configure(uint8_t arg_0x7d9faa58){
#line 49
    /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$ResourceConfigure$default$configure(arg_0x7d9faa58);
#line 49
}
#line 49
# 186 "/opt/tinyos-2.x/tos/system/ArbiterP.nc"
...
inline static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$disable(void ){
#line 40
...
#line 33
{
  /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$disable();
  return SUCCESS;
}
...
#line 50
  result = /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Interrupt$disable();
#line 50
...
#line 35
# 218 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$initPins(void )
#line 218
{
...
#line 35
# 226 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$resetDevice(void )
#line 226
{
  uint8_t i;
...
#line 30
# 237 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$transmissionStart(void )
#line 237
{
  /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$DATA$makeOutput();
...
#line 29
{
  return /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$enable(FALSE);
}
...
#line 43
  result = /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Interrupt$enableFallingEdge();
#line 43
...
#line 43
# 279 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$enableInterrupt(void )
#line 279
{
  /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$DATA$makeInput();
...
# 45 "/opt/tinyos-2.x/tos/chips/atm128/pins/HplAtm128Interrupt.nc"
inline static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$clear(void ){
#line 45
...
inline static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$edge(bool low_to_high){
#line 59
  /*HplAtm128InterruptC.IntPin1*/HplAtm128InterruptPinP$1$Irq$edge(low_to_high);
#line 59
}
#line 59
...
inline static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$enable(void ){
#line 35
  /*HplAtm128InterruptC.IntPin1*/HplAtm128InterruptPinP$1$Irq$enable();
#line 35
}
#line 35
# 370 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$ack(void )
#line 370
{
  /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$DATA$makeOutput();
...
#line 50
{
  return /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qHead == /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY;
}
...
#line 43
  result = /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$isEmpty();
#line 43
...
#line 59
  {
    if (/*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qHead != /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY) {
        uint8_t id = /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qHead;

#line 62
        /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qHead = /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$resQ[/*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qHead];
        if (/*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qHead == /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY) {
          /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qTail = /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY;
          }
#line 65
        /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$resQ[id] = /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY;
        {
          unsigned char __nesc_temp = 
#line 66
          id;
...
#line 68
    {
      unsigned char __nesc_temp = 
#line 68
      /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY;
...
#line 60
  result = /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$dequeue();
#line 60
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$ResourceConfigure$unconfigure(uint8_t arg_0x7d9faa58){
#line 55
    /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$ResourceConfigure$default$unconfigure(arg_0x7d9faa58);
#line 55
}
#line 55
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$ResourceRequested$requested(uint8_t arg_0x7d9fc690){
#line 43
    /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$ResourceRequested$default$requested(arg_0x7d9fc690);
#line 43
}
#line 43
...
#line 54
{
  return /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$resQ[id] != /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY || /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qTail == id;
}
...
#line 73
  {
    if (!/*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$isEnqueued(id)) {
        if (/*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qHead == /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY) {
          /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qHead = id;
          }
        else {
#line 78
          /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$resQ[/*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qTail] = id;
          }
#line 79
        /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$qTail = id;
        {
          unsigned char __nesc_temp = 
#line 80
          SUCCESS;
...
# 69 "/opt/tinyos-2.x/tos/interfaces/ResourceQueue.nc"
inline static error_t /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$Queue$enqueue(resource_client_id_t id){
#line 69
  unsigned char result;
#line 69

#line 69
  result = /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$FcfsQueue$enqueue(id);
#line 69
...
inline static void HplSensirionSht11P$SplitControl$stopDone(error_t error){
#line 117
  /*HplSensirionSht11C.SplitControlPowerManagerC.PowerManager*/PowerManagerP$0$SplitControl$stopDone(error);
#line 117
}
#line 117
# 69 "/opt/tinyos-2.x/tos/platforms/zigbex_core/sensor/sht11/HplSensirionSht11P.nc"
static inline void HplSensirionSht11P$stopTask$runTask(void )
#line 69
{
...
# 84 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11.nc"
inline static void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$measureHumidityDone(uint8_t arg_0x7da78938, error_t result, uint16_t val){
#line 84
  switch (arg_0x7da78938) {
#line 84
    case /*InteractionC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 84
      /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureHumidityDone(result, val);
#line 84
      break;
#line 84
    case /*InteractionC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 84
      /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureHumidityDone(result, val);
#line 84
      break;
#line 84
    default:
#line 84
      /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$default$measureHumidityDone(arg_0x7da78938, result, val);
#line 84
      break;
#line 84
    }
...
# 405 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$default$measureTemperatureDone(uint8_t client, error_t result, uint16_t val)
#line 405
{
}
...
# 69 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11.nc"
inline static void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$measureTemperatureDone(uint8_t arg_0x7da78938, error_t result, uint16_t val){
#line 69
  switch (arg_0x7da78938) {
#line 69
    case /*InteractionC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 69
      /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$measureTemperatureDone(result, val);
#line 69
      break;
#line 69
    case /*InteractionC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 69
      /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$measureTemperatureDone(result, val);
#line 69
      break;
#line 69
    default:
#line 69
      /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$default$measureTemperatureDone(arg_0x7da78938, result, val);
#line 69
      break;
#line 69
    }
...
#line 67
# 318 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$readSensor$runTask(void )
#line 318
{
  uint16_t data = 0;
...
# 116 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11.nc"
inline static void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$writeStatusRegDone(uint8_t arg_0x7da78938, error_t result){
#line 116
  switch (arg_0x7da78938) {
#line 116
    case /*InteractionC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 116
      /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$writeStatusRegDone(result);
#line 116
      break;
#line 116
    case /*InteractionC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 116
      /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$writeStatusRegDone(result);
#line 116
      break;
#line 116
    default:
#line 116
      /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$default$writeStatusRegDone(arg_0x7da78938, result);
#line 116
      break;
#line 116
    }
...
# 100 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11.nc"
inline static void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$readStatusRegDone(uint8_t arg_0x7da78938, error_t result, uint8_t val){
#line 100
  switch (arg_0x7da78938) {
#line 100
    case /*InteractionC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 100
      /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$readStatusRegDone(result, val);
#line 100
      break;
#line 100
    case /*InteractionC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 100
      /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$readStatusRegDone(result, val);
#line 100
      break;
#line 100
    default:
#line 100
      /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$default$readStatusRegDone(arg_0x7da78938, result, val);
#line 100
      break;
#line 100
    }
...
#line 100
# 386 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$signalStatusDone$runTask(void )
#line 386
{
...
#line 56
# 345 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$SendBasicSensor$runTask(void )
#line 345
{
...
# 24 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
inline static void InteractionM$CommunicationWithOPT$SendControlMSG(uint8_t OptType, uint8_t Cmd1, uint8_t Cmd2, uint8_t *SetDataBuff){
#line 24
  CommunicationWithOPTM$CommunicationWithOPT$SendControlMSG(OptType, Cmd1, Cmd2, SetDataBuff);
#line 24
}
#line 24
# 146 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPTM.nc"
static inline void CommunicationWithOPTM$CommunicationWithOPT$SpecialControlMSG(uint8_t TXpacketType, uint8_t OptType, uint8_t Cmd1, uint8_t Cmd2, uint8_t *SetDataBuff, uint8_t RXpacketType)
#line 146
{
...
# 27 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
inline static void InteractionM$CommunicationWithOPT$SpecialControlMSG(uint8_t TXpacketType, uint8_t OptType, uint8_t Cmd1, uint8_t Cmd2, uint8_t *SetDataBuff, uint8_t RXpacketType){
#line 27
  CommunicationWithOPTM$CommunicationWithOPT$SpecialControlMSG(TXpacketType, OptType, Cmd1, Cmd2, SetDataBuff, RXpacketType);
#line 27
}
#line 27
# 16 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/NoSCSuartDBGC.nc"
...
# 30 "/opt/tinyos-2.x/tos/platforms/zigbex_core/SCSuartDBG.nc"
inline static void InteractionM$SCSuartDBG$UARTSend(uint8_t *data, uint8_t len){
#line 30
  NoSCSuartDBGC$SCSuartDBG$UARTSend(data, len);
#line 30
}
#line 30
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void InteractionM$SensorCheckTimer$startPeriodic(uint32_t dt){
#line 53
...
#line 67
# 25 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
inline static void InteractionM$CommunicationWithOPT$RequestSensorMSG(uint8_t OptType){
#line 25
  CommunicationWithOPTM$CommunicationWithOPT$RequestSensorMSG(OptType);
#line 25
}
#line 25
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
#line 55
# 299 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$ProcessCMD$runTask(void )
#line 299
{
  if (InteractionM$RecvCMD.CMD_Data.OptConfig.packetType == 0x02) {
      ...
      InteractionM$SCSuartDBG$UARTSend((uint8_t *)InteractionM$IC_DBG_buff, (uint8_t )strlen(InteractionM$IC_DBG_buff));
...
# 130 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPTM.nc"
static inline void CommunicationWithOPTM$CommunicationWithOPT$RequestLongMSG(uint8_t OptType, uint8_t Seq)
#line 130
{
  CommunicationWithOPTM$CSST.stxm = 0x7E;
...
# 26 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
inline static void InteractionM$CommunicationWithOPT$RequestLongMSG(uint8_t OptType, uint8_t Seq){
#line 26
  CommunicationWithOPTM$CommunicationWithOPT$RequestLongMSG(OptType, Seq);
#line 26
}
#line 26
# 217 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$TryToGetSensorData$runTask(void )
#line 217
{
...
# 124 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static inline void OscopeMotion3AxisM$Interaction$Urgency_Data(uint8_t *Urgency_Payload, uint8_t len)
#line 124
{
}

# 30 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Interaction.nc"
inline static void InteractionM$Interaction$Urgency_Data(uint8_t *Urgency_Payload, uint8_t len){
#line 30
  OscopeMotion3AxisM$Interaction$Urgency_Data(Urgency_Payload, len);
#line 30
}
#line 30
# 140 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$Event_Urgency_Data$runTask(void )
#line 140
{
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void InteractionM$C328_Reset_Timer$startPeriodic(uint32_t dt){
#line 53
...
#line 67
# 72 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$Set_C328_Restart_Timer_START$runTask(void )
#line 72
{
...
inline static void OscopeMotion3AxisM$Leds$led2Toggle(void ){
#line 89
  LedsP$Leds$led2Toggle();
#line 89
}
#line 89
# 64 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static inline void OscopeMotion3AxisM$report_received(void )
#line 64
{
#line 64
  OscopeMotion3AxisM$Leds$led2Toggle();
}
...
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void OscopeMotion3AxisM$Leds$led0Toggle(void ){
#line 56
  LedsP$Leds$led0Toggle();
#line 56
}
#line 56
# 62 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static inline void OscopeMotion3AxisM$report_problem(void )
#line 62
{
#line 62
  OscopeMotion3AxisM$Leds$led0Toggle();
}

# 62 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$AMSend$send(am_id_t arg_0x7e557ce8, am_addr_t addr, message_t * msg, uint8_t len){
#line 62
  unsigned char result;
#line 62

#line 62
  result = CC2420ActiveMessageP$AMSend$send(arg_0x7e557ce8, addr, msg, len);
#line 62
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char result;
#line 64
...
inline static void /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(msg, dest);
  /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(msg, 147);
  return /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(msg, len);
}

# 62 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t OscopeMotion3AxisM$RadioSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 62
  unsigned char result;
#line 62

#line 62
  result = /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(addr, msg, len);
#line 62
...
# 117 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$AMSend$getPayload(am_id_t arg_0x7e557ce8, message_t * msg, uint8_t len){
#line 117
  void *result;
#line 117

#line 117
  result = CC2420ActiveMessageP$AMSend$getPayload(arg_0x7e557ce8, msg, len);
#line 117
...
# 114 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void * /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$getPayload(message_t * msg, uint8_t len){
#line 114
  void *result;
#line 114
...
#line 65
{
  return /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$getPayload(m, len);
}

# 117 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * OscopeMotion3AxisM$RadioSend$getPayload(message_t * msg, uint8_t len){
#line 117
  void *result;
#line 117

#line 117
  result = /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$getPayload(msg, len);
#line 117
...
#line 117
# 155 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline uint8_t CC2420ActiveMessageP$Packet$maxPayloadLength(void )
#line 155
{
  return 28;
...
# 105 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$AMSend$maxPayloadLength(am_id_t arg_0x7e557ce8){
#line 105
  unsigned char result;
#line 105

#line 105
  result = CC2420ActiveMessageP$AMSend$maxPayloadLength(arg_0x7e557ce8);
#line 105
...
inline static uint8_t /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$maxPayloadLength(void ){
#line 101
  unsigned char result;
#line 101
...
#line 61
{
  return /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$maxPayloadLength();
}

# 105 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static uint8_t OscopeMotion3AxisM$RadioSend$maxPayloadLength(void ){
#line 105
  unsigned char result;
#line 105

#line 105
  result = /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$maxPayloadLength();
#line 105
...
#line 105
# 153 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static inline void OscopeMotion3AxisM$checkReadings(void )
#line 153
{
...
#line 155
  if (OscopeMotion3AxisM$reading == NREADINGS) 
    {
      if (!OscopeMotion3AxisM$locked && sizeof OscopeMotion3AxisM$local <= OscopeMotion3AxisM$RadioSend$maxPayloadLength()) 
        {
          memcpy(OscopeMotion3AxisM$RadioSend$getPayload(&OscopeMotion3AxisM$packet, sizeof OscopeMotion3AxisM$local), &OscopeMotion3AxisM$local, sizeof OscopeMotion3AxisM$local);
          if (OscopeMotion3AxisM$RadioSend$send(AM_BROADCAST_ADDR, &OscopeMotion3AxisM$packet, sizeof OscopeMotion3AxisM$local) == SUCCESS) {
            OscopeMotion3AxisM$locked = TRUE;
            }
        }
#line 163
      if (!OscopeMotion3AxisM$locked) {
        OscopeMotion3AxisM$report_problem();
        }
      OscopeMotion3AxisM$reading = 0;

      if (!OscopeMotion3AxisM$suppress_count_change) {
        (__nesc_temp42 = OscopeMotion3AxisM$local.count.data, __nesc_hton_uint16(__nesc_temp42, (__nesc_temp43 = __nesc_ntoh_uint16(__nesc_temp42)) + 1), __nesc_temp43);
        }
#line 170
      OscopeMotion3AxisM$suppress_count_change = FALSE;
    }
}
...
#line 208
{
  uint16_t data1 = __builtin_abs(OscopeMotion3AxisM$prevdata[1] - OscopeMotion3AxisM$currentdata[1]);
  uint16_t data2 = __builtin_abs(OscopeMotion3AxisM$prevdata[2] - OscopeMotion3AxisM$currentdata[2]);
  uint16_t data3 = __builtin_abs(OscopeMotion3AxisM$prevdata[3] - OscopeMotion3AxisM$currentdata[3]);
  uint16_t total = data1 + data2 + data3;




  __nesc_hton_uint16(OscopeMotion3AxisM$local.readings[OscopeMotion3AxisM$reading++].data, total);
  OscopeMotion3AxisM$prevdata[1] = OscopeMotion3AxisM$currentdata[1];
  OscopeMotion3AxisM$prevdata[2] = OscopeMotion3AxisM$currentdata[2];
  OscopeMotion3AxisM$prevdata[3] = OscopeMotion3AxisM$currentdata[3];
}
...
#line 130
{
  uint16_t *pData = &OscopeMotion3AxisM$AP_Frame.AppData.sensor.Sdata.ADC_data[0];

  memcpy(OscopeMotion3AxisM$currentdata + 1, pData, 3 * 2);


  printf("\n[ModeID: 0X%02X, GroupID: 0X%02X]", TOS_NODE_ID, 0x22);
  printf(" X: %d, Y: %d, Z: %d", OscopeMotion3AxisM$currentdata[1], OscopeMotion3AxisM$currentdata[2], OscopeMotion3AxisM$currentdata[3]);
  printfflush();
  ...
  OscopeMotion3AxisM$calc_EUC();
  OscopeMotion3AxisM$checkReadings();
  OscopeMotion3AxisM$report_received();
}

# 27 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Interaction.nc"
inline static void InteractionM$Interaction$getSensorDataDone(App_struct_t *App_Payload, uint8_t app_size){
#line 27
  OscopeMotion3AxisM$Interaction$getSensorDataDone(App_Payload, app_size);
#line 27
}
#line 27
# 63 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$TaskGetSensorDataDone$runTask(void )
#line 63
{
#line 63
...
#line 151
# 62 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7e557ce8, am_addr_t addr, message_t * msg, uint8_t len){
#line 62
  unsigned char result;
#line 62

#line 62
  result = /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$AMSend$send(arg_0x7e557ce8, addr, msg, len);
#line 62
...
# 346 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
static inline uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$dataLinkLength(uart_id_t id, message_t *msg, 
uint8_t upperLen)
#line 347
{
...
# 23 "/opt/tinyos-2.x/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$dataLinkLength(uart_id_t arg_0x7e7b4768, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char result;
#line 23

#line 23
  switch (arg_0x7e7b4768) {
#line 23
...
#line 23
    default:
#line 23
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$dataLinkLength(arg_0x7e7b4768, msg, upperLen);
#line 23
      break;
#line 23
    }
...
# 343 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
static inline uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$offset(uart_id_t id)
#line 343
{
  return 0;
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$offset(uart_id_t arg_0x7e7b4768){
#line 15
  unsigned char result;
#line 15
...
#line 15
    default:
#line 15
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$offset(arg_0x7e7b4768);
#line 15
      break;
#line 15
    }
...
#line 15
# 99 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
static inline error_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Send$send(uint8_t id, message_t *msg, uint8_t len)
#line 99
{
...
#line 70
# 248 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$SendNotifier$default$aboutToSend(am_id_t amId, am_addr_t addr, message_t *msg)
#line 248
{
}
...
# 59 "/opt/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP$SendNotifier$aboutToSend(am_id_t arg_0x7e4782d0, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP$SendNotifier$default$aboutToSend(arg_0x7e4782d0, dest, msg);
#line 59
}
#line 59
...
# 512 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline error_t CC2420TransmitP$send(message_t * p_msg, bool cca)
#line 512
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 258 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$RadioBackoff$default$requestCca(am_id_t id, 
message_t *msg)
#line 259
{
...
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCca(am_id_t arg_0x7e478948, message_t * msg){
#line 95
    CC2420ActiveMessageP$RadioBackoff$default$requestCca(arg_0x7e478948, msg);
#line 95
}
#line 95
...
#line 42
# 123 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline error_t CC2420CsmaP$Send$send(message_t *p_msg, uint8_t len)
#line 123
{
...
#line 45
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool Atm128SpiP$ResourceArbiter$isOwner(uint8_t arg_0x7dfd22e8){
#line 118
  unsigned char result;
#line 118

#line 118
  result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$Resource$isOwner(arg_0x7dfd22e8);
#line 118
...
#line 118
# 83 "/opt/tinyos-2.x/tos/platforms/zigbex_core/chips/cc2420/HplCC2420SpiP.nc"
static inline bool HplCC2420SpiP$Resource$isOwner(void )
{
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceConfigure$configure(uint8_t arg_0x7df0a200){
#line 49
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceConfigure$default$configure(arg_0x7df0a200);
#line 49
}
#line 49
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceRequested$immediateRequested(uint8_t arg_0x7df0b5b0){
#line 51
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceRequested$default$immediateRequested(arg_0x7df0b5b0);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP$ResourceArbiter$immediateRequest(uint8_t arg_0x7dfd22e8){
#line 87
  unsigned char result;
#line 87

#line 87
  result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$Resource$immediateRequest(arg_0x7dfd22e8);
#line 87
...
#line 87
# 56 "/opt/tinyos-2.x/tos/platforms/zigbex_core/chips/cc2420/HplCC2420SpiP.nc"
static inline error_t HplCC2420SpiP$Resource$immediateRequest(void )
{
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceRequested$requested(uint8_t arg_0x7df0b5b0){
#line 43
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceRequested$default$requested(arg_0x7df0b5b0);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP$ResourceArbiter$request(uint8_t arg_0x7dfd22e8){
#line 78
  unsigned char result;
#line 78

#line 78
  result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$Resource$request(arg_0x7dfd22e8);
#line 78
...
#line 56
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void InteractionM$SensorCheckTimer$startOneShot(uint32_t dt){
#line 62
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(2U, dt);
#line 62
}
#line 62
# 281 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$Interaction$SetSamplingTime(uint16_t SamplingInfo)
#line 281
{
...
# 25 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Interaction.nc"
inline static void OscopeMotion3AxisM$Interaction$SetSamplingTime(uint16_t SamplingInfo){
#line 25
  InteractionM$Interaction$SetSamplingTime(SamplingInfo);
#line 25
}
#line 25
# 53 "/opt/tinyos-2.x/tos/lib/timer/Counter.nc"
...
#line 45
# 82 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline error_t CC2420CsmaP$SplitControl$start(void )
#line 82
{
...
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t OscopeMotion3AxisM$RadioCtrl$start(void ){
#line 83
  unsigned char result;
#line 83
...
#line 83
# 73 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static inline void OscopeMotion3AxisM$Interaction$StartDoneConfiguration(uint8_t appType, uint8_t optType)
#line 73
{
  ...
  OscopeMotion3AxisM$currentdata[0] = (optType << 8) | 3 * 2;
  OscopeMotion3AxisM$prevdata[0] = (optType << 8) | 3 * 2;
  OscopeMotion3AxisM$prevdata[1] = 0;
  OscopeMotion3AxisM$prevdata[2] = 0;
  OscopeMotion3AxisM$prevdata[3] = 0;

  OscopeMotion3AxisM$RadioCtrl$start();
  OscopeMotion3AxisM$Interaction$SetSamplingTime(500);
}

# 23 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Interaction.nc"
inline static void InteractionM$Interaction$StartDoneConfiguration(uint8_t appType, uint8_t optType){
#line 23
  OscopeMotion3AxisM$Interaction$StartDoneConfiguration(appType, optType);
#line 23
}
#line 23
# 67 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
...
#line 56
# 111 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$ConfigTimeout$fired(void )
#line 111
{
...
#line 56
# 293 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$SensorCheckTimer$fired(void )
#line 293
{
...
#line 257
              InteractionM$CommunicationWithOPT$SendControlMSG(InteractionM$MyOptType, 0x15, 0, (uint8_t *)EmptyBuff);
...
#line 56
# 180 "/opt/tinyos-2.x/tos/system/ArbiterP.nc"
static inline uint8_t /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$ResourceDefaultOwner$isOwner(void )
#line 180
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 181
      /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$state == /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$RES_CONTROLLED
       ...
       && (/*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$state == /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$RES_GRANTING || /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$state == /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$RES_IMM_GRANTING));
...
inline static bool /*HplSensirionSht11C.SplitControlPowerManagerC.PowerManager*/PowerManagerP$0$ResourceDefaultOwner$isOwner(void ){
#line 65
  unsigned char result;
#line 65

#line 65
  result = /*HplSensirionSht11C.Arbiter.Arbiter*/ArbiterP$0$ResourceDefaultOwner$isOwner();
#line 65
...
#line 92
{
  if (/*HplSensirionSht11C.SplitControlPowerManagerC.PowerManager*/PowerManagerP$0$ResourceDefaultOwner$isOwner()) {
    /*HplSensirionSht11C.SplitControlPowerManagerC.PowerManager*/PowerManagerP$0$ResourceDefaultOwner$release();
    }
}

# 92 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static void HplSensirionSht11P$SplitControl$startDone(error_t error){
#line 92
  /*HplSensirionSht11C.SplitControlPowerManagerC.PowerManager*/PowerManagerP$0$SplitControl$startDone(error);
#line 92
}
#line 92
# 56 "/opt/tinyos-2.x/tos/platforms/zigbex_core/sensor/sht11/HplSensirionSht11P.nc"
static inline void HplSensirionSht11P$Timer$fired(void )
#line 56
{
...
# 404 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$default$resetDone(uint8_t client, error_t result)
#line 404
{
}
...
# 54 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11.nc"
inline static void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$resetDone(uint8_t arg_0x7da78938, error_t result){
#line 54
  switch (arg_0x7da78938) {
#line 54
    case /*InteractionC.SensirionSht11C*/SensirionSht11C$0$TEMP_KEY:
#line 54
      /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Temp$resetDone(result);
#line 54
      break;
#line 54
    case /*InteractionC.SensirionSht11C*/SensirionSht11C$0$HUM_KEY:
#line 54
      /*InteractionC.SensirionSht11C.SensirionSht11ReaderP*/SensirionSht11ReaderP$0$Sht11Hum$resetDone(result);
#line 54
      break;
#line 54
    default:
#line 54
      /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$SensirionSht11$default$resetDone(arg_0x7da78938, result);
#line 54
      break;
#line 54
    }
...
#line 54
# 285 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$Timer$fired(void )
#line 285
{
...
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7dc65010){
#line 72
  switch (arg_0x7dc65010) {
#line 72
    case 1U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7dc65010);
#line 72
      break;
#line 72
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420TinyosNetworkP$NonTinyosReceive$receive(uint8_t arg_0x7dbaa150, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
    result = CC2420TinyosNetworkP$NonTinyosReceive$default$receive(arg_0x7dbaa150, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Snoop$receive(am_id_t arg_0x7e47a880, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
    result = CC2420ActiveMessageP$Snoop$default$receive(arg_0x7e47a880, msg, payload, len);
#line 67
...
#line 67
# 186 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static inline message_t *OscopeMotion3AxisM$RadioRecv$receive(message_t *msg, void *payload, uint8_t len)
#line 186
{
...
#line 189
  ...
  if (__nesc_ntoh_uint16(omsg->version.data) > __nesc_ntoh_uint16(OscopeMotion3AxisM$local.version.data)) 
    {
      __nesc_hton_uint16(OscopeMotion3AxisM$local.version.data, __nesc_ntoh_uint16(omsg->version.data));
      __nesc_hton_uint16(OscopeMotion3AxisM$local.interval.data, __nesc_ntoh_uint16(omsg->interval.data));

      OscopeMotion3AxisM$reading = 0;
    }

  if (__nesc_ntoh_uint16(omsg->count.data) > __nesc_ntoh_uint16(OscopeMotion3AxisM$local.count.data)) 
    {
      __nesc_hton_uint16(OscopeMotion3AxisM$local.count.data, __nesc_ntoh_uint16(omsg->count.data));
      OscopeMotion3AxisM$suppress_count_change = TRUE;
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Receive$receive(am_id_t arg_0x7e47a1e8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
  switch (arg_0x7e47a1e8) {
#line 67
    case 147:
#line 67
      result = OscopeMotion3AxisM$RadioRecv$receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      result = CC2420ActiveMessageP$Receive$default$receive(arg_0x7e47a1e8, msg, payload, len);
#line 67
      break;
#line 67
    }
...
#line 50
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline am_addr_t CC2420ActiveMessageP$AMPacket$address(void )
#line 88
{
...
#line 47
# 171 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline message_t *CC2420ActiveMessageP$SubReceive$receive(message_t *msg, void *payload, uint8_t len)
#line 171
{
...
#line 42
# 448 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline bool CC2420ReceiveP$passesAddressCheck(message_t *msg)
#line 448
{
...
#line 47
# 326 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$receiveDone_task$runTask(void )
#line 326
{
...
#line 31
# 341 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$ChipSpiResource$releasing(void )
#line 341
{
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceConfigure$unconfigure(uint8_t arg_0x7df0a200){
#line 55
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceConfigure$default$unconfigure(arg_0x7df0a200);
#line 55
}
#line 55
# 58 "/opt/tinyos-2.x/tos/system/FcfsResourceQueueC.nc"
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP$ResourceArbiter$release(uint8_t arg_0x7dfd22e8){
#line 110
  unsigned char result;
#line 110

#line 110
  result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$Resource$release(arg_0x7dfd22e8);
#line 110
...
#line 29
# 75 "/opt/tinyos-2.x/tos/platforms/zigbex_core/chips/cc2420/HplCC2420SpiP.nc"
static inline error_t HplCC2420SpiP$Resource$release(void )
{
...
#line 92
# 67 "/opt/tinyos-2.x/tos/platforms/zigbex_core/chips/cc2420/HplCC2420SpiP.nc"
static inline void HplCC2420SpiP$SubResource$granted(void )
{
  HplCC2420SpiP$SS$makeOutput();
  HplCC2420SpiP$SS$clr();
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void Atm128SpiP$Resource$granted(uint8_t arg_0x7dfe02b8){
#line 92
  switch (arg_0x7dfe02b8) {
#line 92
    case 0U:
#line 92
...
#line 92
    default:
#line 92
      Atm128SpiP$Resource$default$granted(arg_0x7dfe02b8);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP$0$Resource$granted(uint8_t arg_0x7df27af8){
#line 92
  Atm128SpiP$ResourceArbiter$granted(arg_0x7df27af8);
#line 92
}
#line 92
...
# 451 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$TXFIFO$readDone(uint8_t *tx_buf, uint8_t tx_len, 
error_t error)
#line 452
{
...
#line 42
# 353 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$CC2420Receive$receive(uint8_t type, message_t *ack_msg)
#line 353
{
...
# 71 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$readDone(uint8_t arg_0x7e06eb78, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x7e06eb78) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP$Fifo$default$readDone(arg_0x7e06eb78, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestInitialBackoff(am_id_t arg_0x7e478948, message_t * msg){
#line 81
    CC2420ActiveMessageP$RadioBackoff$default$requestInitialBackoff(arg_0x7e478948, msg);
#line 81
}
#line 81
...
#line 110
# 637 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline error_t CC2420TransmitP$releaseSpiResource(void )
#line 637
{
...
#line 30
# 419 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$TXFIFO$writeDone(uint8_t *tx_buf, uint8_t tx_len, 
error_t error)
#line 420
{
...
# 318 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$RXFIFO$writeDone(uint8_t *tx_buf, uint8_t tx_len, error_t error)
#line 318
{
}
...
# 91 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$writeDone(uint8_t arg_0x7e06eb78, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x7e06eb78) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP$Fifo$default$writeDone(arg_0x7e06eb78, data, length, error);
#line 91
      break;
#line 91
    }
...
#line 45
# 254 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$RadioBackoff$default$requestCongestionBackoff(am_id_t id, 
message_t *msg)
#line 255
{
...
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCongestionBackoff(am_id_t arg_0x7e478948, message_t * msg){
#line 88
    CC2420ActiveMessageP$RadioBackoff$default$requestCongestionBackoff(arg_0x7e478948, msg);
#line 88
}
#line 88
...
#line 66
# 224 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$SubBackoff$requestCongestionBackoff(message_t *msg)
#line 224
{
...
#line 32
# 89 "/opt/tinyos-2.x/tos/platforms/zigbex_core/chips/cc2420/HplCC2420InterruptsP.nc"
static inline error_t HplCC2420InterruptsP$CCA$enableRisingEdge(void )
#line 89
{
  /* atomic removed: atomic calls only */
...
# 381 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$SpiResource$granted(void )
#line 381
{
  uint8_t cur_state;
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP$Resource$granted(uint8_t arg_0x7e06e148){
#line 92
  switch (arg_0x7e06e148) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP$Resource$default$granted(arg_0x7e06e148);
#line 92
      break;
#line 92
    }
...
#line 76
# 105 "/opt/tinyos-2.x/tos/platforms/zigbex_core/chips/cc2420/HplCC2420InterruptsP.nc"
static inline error_t HplCC2420InterruptsP$CCA$disable(void )
#line 105
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 191 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$CC2420Config$syncDone(error_t error)
#line 191
{
}

# 347 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$CC2420Config$syncDone(error_t error)
#line 347
{
}
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(message_t * msg, error_t error){
#line 92
  OscopeMotion3AxisM$RadioSend$sendDone(msg, error);
#line 92
}
#line 92
...
#line 57
{
  /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$Send$sendDone(uint8_t arg_0x7e557300, message_t * msg, error_t error){
#line 89
  switch (arg_0x7e557300) {
#line 89
    case 0U:
#line 89
      /*OscopeMotion3AxisC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$Send$default$sendDone(arg_0x7e557300, msg, error);
#line 89
      break;
#line 89
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP$AMSend$sendDone(am_id_t arg_0x7e480818, message_t * msg, error_t error){
#line 92
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$AMSend$sendDone(arg_0x7e480818, msg, error);
#line 92
}
#line 92
# 165 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$SubSend$sendDone(message_t *msg, error_t result)
#line 165
{
...
#line 50
# 134 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline error_t CC2420ReceiveP$StdControl$stop(void )
#line 134
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 84
# 269 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$shutdown(void )
#line 269
{
...
inline static void OscopeMotion3AxisM$Leds$led1Toggle(void ){
#line 72
  LedsP$Leds$led1Toggle();
#line 72
}
#line 72
# 63 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static inline void OscopeMotion3AxisM$report_sent(void )
#line 63
{
#line 63
  OscopeMotion3AxisM$Leds$led1Toggle();
}
...
#line 117
  OscopeMotion3AxisM$RadioCtrl$stopDone(error);
#line 117
}
#line 117
# 259 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$stopDone_task$runTask(void )
#line 259
{
...
# 105 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static inline void OscopeMotion3AxisM$RadioCtrl$startDone(error_t error)
#line 105
{
  if (error == SUCCESS) {
...
#line 92
  OscopeMotion3AxisM$RadioCtrl$startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
#line 74
# 251 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$startDone_task$runTask(void )
#line 251
{
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7e557300, message_t * msg, error_t error){
#line 89
  switch (arg_0x7e557300) {
#line 89
    case 0U:
...
#line 89
    default:
#line 89
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7e557300, msg, error);
#line 89
      break;
#line 89
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$AMSend$sendDone(am_id_t arg_0x7e9449d0, message_t * msg, error_t error){
#line 92
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7e9449d0, msg, error);
#line 92
}
#line 92
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Send$sendDone(uart_id_t arg_0x7e7b6b98, message_t * msg, error_t error){
#line 89
  switch (arg_0x7e7b6b98) {
#line 89
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 89
...
#line 89
    default:
#line 89
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Send$default$sendDone(arg_0x7e7b6b98, msg, error);
#line 89
      break;
#line 89
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$Receive$receive(am_id_t arg_0x7e924468, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
    result = /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$Receive$default$receive(arg_0x7e924468, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Receive$receive(uart_id_t arg_0x7e7b6558, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
  switch (arg_0x7e7b6558) {
#line 67
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 67
...
#line 67
    default:
#line 67
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Receive$default$receive(arg_0x7e7b6558, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 31 "/opt/tinyos-2.x/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$upperLength(uart_id_t arg_0x7e7b4768, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char result;
#line 31
...
#line 31
    default:
#line 31
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$upperLength(arg_0x7e7b4768, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
#line 31
# 263 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
static inline void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$receiveTask$runTask(void )
#line 263
{
  uart_id_t myType;
...
#line 44
# 126 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$Uart0RxControl$stop(void )
#line 126
{
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void InteractionM$ConfigTimeout$startOneShot(uint32_t dt){
#line 62
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(1U, dt);
#line 62
}
#line 62
# 72 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPTM.nc"
static inline void CommunicationWithOPTM$CommunicationWithOPT$SendConfigureMSG(void )
#line 72
{
...
# 22 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
...
#line 22
# 237 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$HplUart1$enableRxIntr(void )
#line 237
{
...
#line 42
# 226 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$HplUart1$enableTxIntr(void )
#line 226
{
...
#line 40
# 214 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$Uart1RxControl$start(void )
#line 214
{
...
#line 74
# 202 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$Uart1TxControl$start(void )
#line 202
{
...
#line 74
# 56 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPTM.nc"
static inline void CommunicationWithOPTM$CommunicationWithOPT$start(void )
#line 56
{
  ...
  CommunicationWithOPTM$LDST_Size = (uint8_t )sizeof(longData_struct_t );
  CommunicationWithOPTM$CSST.stxm = 0x7E;
  CommunicationWithOPTM$CSST.etxm = 0x7E;
...
# 21 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
...
#line 21
# 77 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$Interaction$StartConfiguration(App_struct_t *App_Payload)
#line 77
{
...
# 22 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/Interaction.nc"
inline static void OscopeMotion3AxisM$Interaction$StartConfiguration(App_struct_t *App_Payload){
#line 22
  InteractionM$Interaction$StartConfiguration(App_Payload);
#line 22
}
#line 22
# 66 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static inline void OscopeMotion3AxisM$Boot$booted(void )
#line 66
{
  __nesc_hton_uint16(OscopeMotion3AxisM$local.interval.data, 1000);
  __nesc_hton_uint16(OscopeMotion3AxisM$local.id.data, TOS_NODE_ID);
  __nesc_hton_uint16(OscopeMotion3AxisM$local.count.data, 0);
  OscopeMotion3AxisM$Interaction$StartConfiguration(&OscopeMotion3AxisM$AP_Frame);
}

# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
inline static void PrintfP$Boot$booted(void ){
#line 49
  OscopeMotion3AxisM$Boot$booted();
#line 49
}
#line 49
...
#line 92
# 143 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$HplUart0$enableRxIntr(void )
#line 143
{
...
#line 42
# 120 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$Uart0RxControl$start(void )
#line 120
{
  * (volatile uint8_t *)(0x0A + 0x20) |= 1 << 4;
...
#line 74
# 108 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$Uart0TxControl$start(void )
#line 108
{
  * (volatile uint8_t *)(0x0A + 0x20) |= 1 << 3;
...
#line 74
# 148 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$HplUart0$disableRxIntr(void )
#line 148
{
  * (volatile uint8_t *)(0x0A + 0x20) &= ~(1 << 7);
...
#line 43
# 138 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$HplUart0$disableTxIntr(void )
#line 138
{
...
#line 56
# 182 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
static inline void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$SendBytePacket$sendCompleted(error_t error)
#line 182
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 56
# 132 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$HplUart0$enableTxIntr(void )
#line 132
{
...
# 120 "/opt/tinyos-2.x/tos/platforms/zigbex_core/MeasureClockC.nc"
static inline uint16_t MeasureClockC$Atm128Calibrate$baudrateRegister(uint32_t baudrate)
#line 120
{
...
#line 60
# 182 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static inline error_t HplAtm128UartP$Uart1Init$init(void )
#line 182
{
  ...
  ubrr1 = HplAtm128UartP$Atm128Calibrate$baudrateRegister(57600L);
...
#line 88
{
  ...
  ubrr0 = HplAtm128UartP$Atm128Calibrate$baudrateRegister(57600L);
...
#line 45
{
  memset(/*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$resQ, /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$NO_ENTRY, sizeof /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$resQ);
  return SUCCESS;
}
...
#line 51
  result = ecombine(result, /*HplSensirionSht11C.Arbiter.Queue*/FcfsResourceQueueC$1$Init$init());
#line 51
...
# 191 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
static inline void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$lockCurrentBuffer(void )
#line 191
{
...
#line 69
# 209 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
static inline void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$receiveBufferSwap(void )
#line 209
{
...
# 232 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
static inline void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$ReceiveBytePacket$byteReceived(uint8_t b)
#line 232
{
  /* atomic removed: atomic calls only */
...
#line 60
# 166 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
static inline uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$SendBytePacket$nextByte(void )
#line 166
{
  uint8_t b;
...
#line 47
# 181 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$CommunicationWithOPT$parsing_longDT(uint8_t *RecvMsg)
#line 181
{
...
#line 198
        pack->data[0] == 0x0A && pack->data[1] == 0xAA)
         || (pack->data[0] == 0xAA && pack->data[1] == 0x0A)) {
            ...
            InteractionM$Seq_For_LongData = (uint8_t )(pack->subCmd1 + 1);
          }
        }
    }
  ...
  InteractionM$Return_App_Size += (uint8_t )(pack->dataLength + 1);
  InteractionM$TaskGetSensorDataDone$postTask();
}

# 32 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
inline static void CommunicationWithOPTM$CommunicationWithOPT$parsing_longDT(uint8_t *RecvMsg){
#line 32
  InteractionM$CommunicationWithOPT$parsing_longDT(RecvMsg);
#line 32
}
#line 32
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
#line 56
# 144 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$CommunicationWithOPT$parsing_control(uint8_t *RecvMsg)
#line 144
{
...
# 31 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
inline static void CommunicationWithOPTM$CommunicationWithOPT$parsing_control(uint8_t *RecvMsg){
#line 31
  InteractionM$CommunicationWithOPT$parsing_control(RecvMsg);
#line 31
}
#line 31
# 120 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$CommunicationWithOPT$parsing_sensor(uint8_t *RecvMsg)
#line 120
{
  configuration_sampling_struct_t *pack = (configuration_sampling_struct_t *)RecvMsg;
...
# 30 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
inline static void CommunicationWithOPTM$CommunicationWithOPT$parsing_sensor(uint8_t *RecvMsg){
#line 30
  InteractionM$CommunicationWithOPT$parsing_sensor(RecvMsg);
#line 30
}
#line 30
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
#line 56
# 92 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static inline void InteractionM$CommunicationWithOPT$parsing_config(uint8_t *RecvMsg)
#line 92
{
  configuration_sampling_struct_t *pack = (configuration_sampling_struct_t *)RecvMsg;

  InteractionM$MyOptType = (uint8_t )pack->optType;
...
# 29 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPT.nc"
inline static void CommunicationWithOPTM$CommunicationWithOPT$parsing_config(uint8_t *RecvMsg){
#line 29
  InteractionM$CommunicationWithOPT$parsing_config(RecvMsg);
#line 29
}
#line 29
# 165 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPTM.nc"
static inline void CommunicationWithOPTM$HPLUART$rxDone(uint8_t data)
#line 165
{
...
#line 49
  CommunicationWithOPTM$HPLUART$rxDone(data);
#line 49
}
#line 49
#line 46
inline static void CommunicationWithOPTM$HPLUART$tx(uint8_t data){
#line 46
  HplAtm128UartP$HplUart1$tx(data);
#line 46
}
#line 46
# 283 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPTM.nc"
static inline void CommunicationWithOPTM$HPLUART$txDone(void )
#line 283
{
...
#line 32
# 463 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$BackoffTimer$fired(void )
#line 463
{
  /* atomic removed: atomic calls only */
...
#line 59
# 158 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$CC2420Receive$sfd_dropped(void )
#line 158
{
  if (CC2420ReceiveP$m_timestamp_size) {
...
#line 32
# 149 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$CC2420Receive$sfd(uint32_t time)
#line 149
{
...
#line 63
# 158 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static inline bool CC2420PacketP$PacketTimeSyncOffset$isSet(message_t *msg)
{
...
#line 56
# 313 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static inline void /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$InterruptDATA$fired(void )
#line 313
{
  /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$InterruptDATA$disable();
...
# 57 "/opt/tinyos-2.x/tos/interfaces/GpioInterrupt.nc"
inline static void /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Interrupt$fired(void ){
#line 57
...
#line 38
{
  /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Interrupt$fired();
}

# 64 "/opt/tinyos-2.x/tos/chips/atm128/pins/HplAtm128Interrupt.nc"
inline static void /*HplAtm128InterruptC.IntPin1*/HplAtm128InterruptPinP$1$Irq$fired(void ){
#line 64
  /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$fired();
#line 64
}
#line 64
# 61 "/opt/tinyos-2.x/tos/chips/atm128/pins/HplAtm128InterruptPinP.nc"
...
#line 41
# 175 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$InterruptFIFOP$fired(void )
#line 175
{
...
#line 96
# 265 "/opt/tinyos-2.x/tos/chips/atm128/spi/Atm128SpiP.nc"
static inline void Atm128SpiP$Spi$dataReady(uint8_t data)
#line 265
{
  bool again;
...
#line 92
# 46 "/opt/tinyos-2.x/tos/chips/atm128/adc/HplAtm128AdcP.nc"
static inline uint16_t HplAtm128AdcP$HplAtm128Adc$getValue(void )
#line 46
{
...
# 66 "/opt/tinyos-2.x/tos/interfaces/ReadNow.nc"
inline static void AdcP$ReadNow$readDone(uint8_t arg_0x7d9014c8, error_t result, AdcP$ReadNow$val_t val){
#line 66
    AdcP$ReadNow$default$readDone(arg_0x7d9014c8, result, val);
#line 66
}
#line 66
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
#line 72
# 78 "/opt/tinyos-2.x/tos/chips/atm128/adc/HplAtm128AdcP.nc"
static inline void HplAtm128AdcP$HplAtm128Adc$disableInterruption(void )
#line 78
{
#line 78
...
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x7eee2580){
#line 64
  switch (arg_0x7eee2580) {
#line 64
    case SerialP$RunTx:
#line 64
...
#line 64
    default:
#line 64
      SchedulerBasicP$TaskBasic$default$runTask(arg_0x7eee2580);
#line 64
      break;
#line 64
    }
...
#line 109
    {
      if (/*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$state == /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$RES_BUSY && /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$resId == id) {
          if (/*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$Queue$isEmpty() == FALSE) {
              ...
              /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$resId = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$default_owner_id;
              /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$state = /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$RES_CONTROLLED;
              /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceConfigure$unconfigure(id);
              /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceDefaultOwner$granted();
            }
          {
            unsigned char __nesc_temp = 
#line 123
...
#line 87
    __nesc_atomic_end(__nesc_atomic); }
#line 86
  /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP$1$ResourceDefaultOwner$requested();
  return SUCCESS;
}
...
# 147 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static error_t /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$performCommand(void )
#line 147
{
...
#line 16
    {
      /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$disable();
      /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$clear();
      /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$edge(rising);
      /*HplSensirionSht11C.InterruptDATAC*/Atm128GpioInterruptC$1$Atm128Interrupt$enable();
    }
#line 21
    __nesc_atomic_end(__nesc_atomic); }
  return SUCCESS;
...
# 353 "/opt/tinyos-2.x/tos/chips/sht11/SensirionSht11LogicP.nc"
static uint8_t /*HalSensirionSht11C.SensirionSht11LogicP*/SensirionSht11LogicP$0$readByte(void )
#line 353
{
  uint8_t byte = 0;
...
# 117 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPTM.nc"
static void CommunicationWithOPTM$CommunicationWithOPT$RequestSensorMSG(uint8_t OptType)
#line 117
{
  CommunicationWithOPTM$CSST.stxm = 0x7E;
...
# 259 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static void HplAtm128UartP$HplUart1$tx(uint8_t data)
#line 259
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 99 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/CommunicationWithOPTM.nc"
static void CommunicationWithOPTM$CommunicationWithOPT$SendControlMSG(uint8_t OptType, uint8_t Cmd1, uint8_t Cmd2, uint8_t *SetDataBuff)
#line 99
{
  CommunicationWithOPTM$CSST.stxm = 0x7E;
...
# 66 "/opt/tinyos-2.x/tos/sensorboards/extra_sensor/InteractionM.nc"
static void InteractionM$SetC327_Check_Value(uint8_t check_value)
#line 66
{
  InteractionM$C328_Reset_Timer_Check = (uint8_t )(InteractionM$C328_Reset_Timer_Counter + check_value);
...
# 629 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static error_t CC2420TransmitP$acquireSpiResource(void )
#line 629
{
...
# 659 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static void CC2420TransmitP$loadTXFIFO(void )
#line 659
{
...
# 399 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static void CC2420ReceiveP$waitForNextPacket(void )
#line 399
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 354 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static void CC2420ReceiveP$beginReceive(void )
#line 354
{
...
# 372 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static void CC2420ReceiveP$flush(void )
#line 372
{
  CC2420ReceiveP$reset_state();
...
# 684 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static void CC2420TransmitP$signalDone(error_t err)
#line 684
{
  /* atomic removed: atomic calls only */
...
# 175 "/cygdrive/c/ZigbeXStudio/workspace/OscilloscopeMotionAxis/src/OscopeMotion3AxisM.nc"
static void OscopeMotion3AxisM$RadioSend$sendDone(message_t *msg, error_t error)
#line 175
{
  if (&OscopeMotion3AxisM$packet == msg) {
      OscopeMotion3AxisM$locked = FALSE;
    }

  if (error == SUCCESS) {
    OscopeMotion3AxisM$report_sent();
    }
  else {
#line 183
    OscopeMotion3AxisM$report_problem();
...
# 165 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
static void HplAtm128UartP$HplUart0$tx(uint8_t data)
#line 165
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 284 "/opt/tinyos-2.x/tos/lib/serial/SerialDispatcherP.nc"
static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$ReceiveBytePacket$endPacket(error_t result)
#line 284
{
...
# 178 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
...
# 266 "/opt/tinyos-2.x/tos/chips/atm128/HplAtm128UartP.nc"
...
# 168 "/opt/tinyos-2.x/tos/lib/printf/PrintfP.nc"
...
# 167 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static uint8_t CC2420PacketP$PacketTimeSyncOffset$get(message_t *msg)
{
...
# 99 "/opt/tinyos-2.x/tos/chips/atm128/adc/HplAtm128AdcP.nc"
